            ...
            return (
              <tr key={_id}>
                ...
                <td
                  onClick={() => {
                    if (classesBeforeBreak[0]?.courseCode ||
                      ...
                      handleClickTD(_id, classesBeforeBreak[0]?.rowIndex, classesBeforeBreak[0]?.credit);
                    }
                  }}
                  onDoubleClick={() => {
                    if (classesBeforeBreak[0]?.courseCode ||
                  ...
                  colSpan={`${classesBeforeBreak[0]?.courseCode ===
                    classesBeforeBreak[1]?.courseCode
                    ? "6"
                    : "3"
                    }`}
                  className={`px-[16px] border-r-[1px] py-[6px] text-[#000] border-[#000] border-2 text-[14px] cursor-pointer ${swapClass?.routineId === _id && (swapClass?.firstRowIndex === classesBeforeBreak[0]?.rowIndex || swapClass?.secondRowIndex === classesBeforeBreak[0]?.rowIndex) && 'bg-purple-500'}`}
                >
                ...
                {classesBeforeBreak[0]?.courseCode !==
                  ...
                  <td
                    onClick={() => {
                      if (classesBeforeBreak[1]?.courseCode ||
                        classesBeforeBreak[1]?.courseTitle) {
                        handleClickTD(_id, classesBeforeBreak[1]?.rowIndex, classesBeforeBreak[1]?.credit);
                      }
                    }}
                    onDoubleClick={() => {
                      if (classesBeforeBreak[1]?.courseCode ||
                    ...
                    colSpan={`${classesBeforeBreak[1]?.courseCode ===
                      classesBeforeBreak[2]?.courseCode
                      ? "6"
                      : "3"
                      }`}
                    className={`px-[16px] border-r-[1px] py-[6px] text-[#000] border-[#000] border-2 text-[14px] cursor-pointer  ${swapClass?.routineId === _id && (swapClass?.firstRowIndex === classesBeforeBreak[1]?.rowIndex || swapClass?.secondRowIndex === classesBeforeBreak[1]?.rowIndex) && 'bg-purple-500'}`}
                  >
                    {classesBeforeBreak[1]?.courseCode && (
                      <>
                        {classesBeforeBreak[1]?.courseCode} (
                ...
                <td
                  onClick={() => {
                    if (classesBeforeBreak[2]?.courseTitle || classesBeforeBreak[2]?.courseCode) {
                      handleClickTD(_id, classesBeforeBreak[2]?.rowIndex, classesBeforeBreak[2]?.credit);
                    }
                  ...
                  colSpan={`${classesBeforeBreak[2]?.courseCode ===
                    classesBeforeBreak[3]?.courseCode
                    ? "6"
                    : "3"
                    }`}
                  className={`px-[16px] border-r-[1px] py-[6px] text-[#000] border-[#000] border-2 text-[14px] cursor-pointer  ${swapClass?.routineId === _id && (swapClass?.firstRowIndex === classesBeforeBreak[2]?.rowIndex || swapClass?.secondRowIndex === classesBeforeBreak[2]?.rowIndex) && 'bg-purple-500'}`}
                >
                  {classesBeforeBreak[2]?.courseCode && (
                    <>
                      {classesBeforeBreak[2]?.courseCode} (
                ...
                {classesBeforeBreak[2]?.courseCode !==
                  ...
                  <td
                    ...
                    onClick={() => {
                      if (classesBeforeBreak[3]?.courseTitle || classesBeforeBreak[3]?.courseCode) {
                        handleClickTD(_id, classesBeforeBreak[3]?.rowIndex, classesBeforeBreak[3]?.credit);
                      }
                    }}
                    onDoubleClick={() => {
                      if (classesBeforeBreak[3]?.courseTitle || classesBeforeBreak[3]?.courseCode) {
                    ...
                    colSpan={3}
                    className={`px-[16px] border-r-[1px] py-[6px] text-[#000] border-[#000] border-2 text-[14px] cursor-pointer  ${swapClass?.routineId === _id && (swapClass?.firstRowIndex === classesBeforeBreak[3]?.rowIndex || swapClass?.secondRowIndex === classesBeforeBreak[3]?.rowIndex) && 'bg-purple-500'}`}
                  >
                    {classesBeforeBreak[3]?.courseCode && (
                      <>
                        {classesBeforeBreak[3]?.courseCode} (
                ...
                {/* Number 5 */}
                  <td
                    onClick={() => {
                      if(classesAfterBreak[0]?.courseTitle || classesAfterBreak[0]?.courseCode){
                        handleClickTD(_id, classesAfterBreak[0]?.rowIndex, classesAfterBreak[0]?.credit);
                      }
                    }}
                    onDoubleClick={() => {
                      if(classesAfterBreak[0]?.courseTitle || classesAfterBreak[0]?.courseCode){
                    ...
                    colSpan={`${classesAfterBreak[0]?.courseCode ===
                      classesAfterBreak[1]?.courseCode
                      ? "6"
                      : "3"
                      }`}
                    className={`px-[16px] border-r-[1px] py-[6px] text-[#000] border-[#000] border-2 text-[14px] cursor-pointer  ${swapClass?.routineId === _id && (swapClass?.firstRowIndex === classesAfterBreak[0]?.rowIndex || swapClass?.secondRowIndex === classesAfterBreak[0]?.rowIndex) && 'bg-purple-500'}`}
                  >
                  ...
                  <td
                    onClick={() => {
                      if(classesAfterBreak[1]?.courseCode || classesAfterBreak[1]?.courseCode){
                        handleClickTD(_id, classesAfterBreak[1]?.rowIndex, classesAfterBreak[1]?.credit);
                      }
                    }}
                    onDoubleClick={() => {
                      if(classesAfterBreak[1]?.courseCode || classesAfterBreak[1]?.courseTitle){
                        setCourseId(_id);
                    ...
                    colSpan={`${classesAfterBreak[1]?.courseCode ===
                      classesAfterBreak[2]?.courseCode
                      ? "6"
                      : "3"
                      }`}
                    className={`px-[16px] border-r-[1px] py-[6px] text-[#000] border-[#000] border-2 text-[14px] cursor-pointer ${swapClass?.routineId === _id && (swapClass?.firstRowIndex === classesAfterBreak[1]?.rowIndex || swapClass?.secondRowIndex === classesAfterBreak[1]?.rowIndex) && 'bg-purple-500'}`}
                  >
                    {classesAfterBreak[1]?.courseCode && (
                      <>
                        {classesAfterBreak[1]?.courseCode} (
                ...
                {classesAfterBreak[1]?.courseCode !==
                  classesAfterBreak[2]?.courseCode &&
                   (
                    <td
                      onClick={() => {
                        if(classesAfterBreak[2]?.courseCode || classesAfterBreak[2]?.courseTitle){
                          handleClickTD(_id, classesAfterBreak[2]?.rowIndex, classesAfterBreak[2]?.credit);
                        }
                      }}
                      onDoubleClick={() => {
                        if(classesAfterBreak[2]?.courseCode || classesAfterBreak[2]?.courseTitle){
                      ...
                      colSpan={3}
                      className={`px-[16px] border-r-[1px] py-[6px] text-[#000] border-[#000] border-2 text-[14px] cursor-pointer ${swapClass?.routineId === _id && (swapClass?.firstRowIndex === classesAfterBreak[2]?.rowIndex || swapClass?.secondRowIndex === classesAfterBreak[2]?.rowIndex) && 'bg-purple-500'}`}
                    >
                      {classesAfterBreak[2]?.courseCode && (
                        <>
                          {classesAfterBreak[2]?.courseCode} (
                ...
                {/* 7 and 8 */}
                  ...
                  <td
                    onClick={() => {
                      if(classesAfterBreak[3]?.courseCode || classesAfterBreak[3]?.courseTitle){
                        handleClickTD(_id, classesAfterBreak[3]?.rowIndex, classesAfterBreak[3]?.credit);
                      }
                    }}
                    onDoubleClick={() => {
                      if(classesAfterBreak[3]?.courseCode || classesAfterBreak[3]?.courseTitle){
                    ...
                    colSpan={`${classesAfterBreak[3]?.courseCode ===
                      classesAfterBreak[4]?.courseCode
                      ? "6"
                      : "3"
                      }`}
                    className={`px-[16px] border-r-[1px] py-[6px] text-[#000] border-[#000] border-2 text-[14px] cursor-pointer ${swapClass?.routineId === _id && (swapClass?.firstRowIndex === classesAfterBreak[3]?.rowIndex || swapClass?.secondRowIndex === classesAfterBreak[3]?.rowIndex) && 'bg-purple-500'}`}
                  >
                ...
                {classesAfterBreak[3]?.courseCode !==
                  classesAfterBreak[4]?.courseCode &&
                    <td
                      ...
                      onClick={() => {
                        if(classesAfterBreak[4]?.courseCode || classesAfterBreak[4]?.courseTitle){
                          handleClickTD(_id, classesAfterBreak[4]?.rowIndex, classesAfterBreak[4]?.credit);
                        }
                      }}
                      onDoubleClick={() => {
                        if(classesAfterBreak[4]?.courseCode || classesAfterBreak[4]?.courseTitle){
                      ...
                      colSpan={3}
                      className={`px-[16px] border-r-[1px] py-[6px] text-[#000] border-[#000] border-2 text-[14px] cursor-pointer ${swapClass?.routineId === _id && (swapClass?.firstRowIndex === classesAfterBreak[4]?.rowIndex || swapClass?.secondRowIndex === classesAfterBreak[4]?.rowIndex) && 'bg-purple-500'}`}
                    >
                      {classesAfterBreak[4]?.courseCode && (
                        <>
                          {classesAfterBreak[4]?.courseCode} (
                  ...
                  <td
                    onClick={() => {
                      if(classesAfterBreak[5]?.courseCode || classesAfterBreak[5]?.courseTitle){
                        handleClickTD(_id, classesAfterBreak[5]?.rowIndex, classesAfterBreak[5]?.credit);
                      }
                    }}
                    onDoubleClick={() => {
                      if(classesAfterBreak[5]?.courseCode || classesAfterBreak[5]?.courseTitle){
                    ...
                    colSpan={`${classesAfterBreak[5]?.courseCode ===
                      classesAfterBreak[6]?.courseCode
                      ? "6"
                      : "3"
                      }`}
                    className={`px-[16px] border-r-[1px] py-[6px] text-[#000] border-[#000] border-2 text-[14px] cursor-pointer ${swapClass?.routineId === _id && (swapClass?.firstRowIndex === classesAfterBreak[5]?.rowIndex || swapClass?.secondRowIndex === classesAfterBreak[5]?.rowIndex) && 'bg-purple-500'}`}
                  >
                ...
                {classesAfterBreak[5]?.courseCode !==
                  classesAfterBreak[6]?.courseCode &&
                    <td
                      onClick={() => {
                        if(classesAfterBreak[6]?.courseCode || classesAfterBreak[6]?.courseTitle){
                          handleClickTD(_id, classesAfterBreak[6]?.rowIndex, classesAfterBreak[6]?.credit);
                        }
                      }}
                      onDoubleClick={() => {
                        if(classesAfterBreak[6]?.courseCode || classesAfterBreak[6]?.courseTitle){
                      ...
                      colSpan={3}
                      className={`px-[16px] border-r-[1px] py-[6px] text-[#000] border-[#000] border-2 text-[14px] cursor-pointer ${swapClass?.routineId === _id && (swapClass?.firstRowIndex === classesAfterBreak[6]?.rowIndex || swapClass?.secondRowIndex === classesAfterBreak[6]?.rowIndex) && 'bg-purple-500'}`}
                    >
                      {classesAfterBreak[6]?.courseCode && (
                        <>
                          {classesAfterBreak[6]?.courseCode} (
